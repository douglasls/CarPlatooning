...
################################################################
# This is a generated script based on design: camera_vga
#
...
proc create_root_design { parentCell } {
 ...
 ] [get_bd_pins /ov7670_controller_0/reset]
  ...
  connect_bd_net -net Net [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins debounce_0/clk] [get_bd_pins ov7670_controller_0/clk]
  ...
  connect_bd_net -net button_debounce_1 [get_bd_ports button_debounce] [get_bd_pins debounce_0/i]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins ov7670_vga_0/clk25]
  ...
  connect_bd_net -net ov7670_vsync_1 [get_bd_ports ov7670_vsync] [get_bd_pins ov7670_capture_0/vsync]
