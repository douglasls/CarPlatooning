...
HD_PWD='C:/Users/DLustosa/Desktop/Exemplo_vivado/CAM_OV7670_ZYBO/CAM_OV7670_ZYBO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log camera_vga_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source camera_vga_wrapper.tcl
