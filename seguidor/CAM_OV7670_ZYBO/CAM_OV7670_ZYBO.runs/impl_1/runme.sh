...
HD_PWD='C:/Users/DLustosa/Desktop/Exemplo_vivado/CAM_OV7670_ZYBO/CAM_OV7670_ZYBO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log camera_vga_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source camera_vga_wrapper.tcl -notrace
