...
################################################################
# This is a generated script based on design: cam_pmodtest_arthur
#
...
# source cam_pmodtest_arthur_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# Address_Generator, RGB, VGA, comandostop_v1_0, debounce, ov7670_capture, ov7670_controller
...
set design_name cam_pmodtest_arthur
...
proc create_root_design { parentCell } {
  ...
  set o7670_pwdn [ create_bd_port -dir O o7670_pwdn ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins comandostop_v1_0_0/s00_axi] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net Address_Generator_0_address [get_bd_pins Address_Generator_0/address] [get_bd_pins blk_mem_gen_0/addrb]
  connect_bd_net -net Net [get_bd_pins Address_Generator_0/enable] [get_bd_pins RGB_0/Nblank] [get_bd_pins VGA_0/activeArea]
  connect_bd_net -net Net1 [get_bd_ports ov7670_pclk] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins ov7670_capture_0/pclk]
  connect_bd_net -net Net2 [get_bd_ports ov7670_siod] [get_bd_pins ov7670_controller_0/siod]
  connect_bd_net -net Net3 [get_bd_ports ov7670_vsync] [get_bd_pins comandostop_v1_0_0/vsync_i] [get_bd_pins ov7670_capture_0/vsync]
  connect_bd_net -net RGB_0_B [get_bd_ports vga_b] [get_bd_pins RGB_0/B]
  connect_bd_net -net RGB_0_G [get_bd_ports vga_g] [get_bd_pins RGB_0/G]
  connect_bd_net -net RGB_0_R [get_bd_ports vga_r] [get_bd_pins RGB_0/R]
  connect_bd_net -net VGA_0_Hsync [get_bd_ports vga_hs] [get_bd_pins VGA_0/Hsync]
  connect_bd_net -net VGA_0_Vsync [get_bd_ports vga_vs] [get_bd_pins Address_Generator_0/vsync] [get_bd_pins VGA_0/Vsync]
  ...
  connect_bd_net -net ov7670_controller_0_pwdn [get_bd_ports o7670_pwdn] [get_bd_pins ov7670_controller_0/pwdn]
  ...
  connect_bd_net -net ov7670_d_1 [get_bd_ports ov7670_d] [get_bd_pins ov7670_capture_0/d]
  connect_bd_net -net ov7670_href_1 [get_bd_ports ov7670_href] [get_bd_pins ov7670_capture_0/href]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins comandostop_v1_0_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins comandostop_v1_0_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins Address_Generator_0/rez_160x120] [get_bd_pins VGA_0/rez_160x120] [get_bd_pins ov7670_capture_0/rez_160x120] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins Address_Generator_0/rez_320x240] [get_bd_pins VGA_0/rez_320x240] [get_bd_pins ov7670_capture_0/rez_320x240] [get_bd_pins xlconstant_1/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs comandostop_v1_0_0/s00_axi/reg0] SEG_comandostop_v1_0_0_reg0
