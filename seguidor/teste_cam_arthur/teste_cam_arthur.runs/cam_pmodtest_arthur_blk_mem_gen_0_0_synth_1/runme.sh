...
HD_PWD='C:/Users/DLustosa/Desktop/Exemplo_vivado/teste_cam_arthur/teste_cam_arthur.runs/cam_pmodtest_arthur_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cam_pmodtest_arthur_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cam_pmodtest_arthur_blk_mem_gen_0_0.tcl
