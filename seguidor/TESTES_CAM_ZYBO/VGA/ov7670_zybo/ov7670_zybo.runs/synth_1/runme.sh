...
HD_PWD='C:/Users/dougl/Desktop/CarPlatooning/seguidor/TESTES_CAM_ZYBO/VGA/ov7670_zybo/ov7670_zybo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log camera_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source camera_wrapper.tcl
