...
HD_PWD='C:/Users/dougl/Desktop/CarPlatooning/seguidor/TESTES_CAM_ZYBO/VGA/ov7670_zybo/ov7670_zybo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log camera_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source camera_wrapper.tcl -notrace
