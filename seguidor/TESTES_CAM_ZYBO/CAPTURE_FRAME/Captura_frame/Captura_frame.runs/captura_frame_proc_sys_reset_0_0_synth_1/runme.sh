...
HD_PWD='C:/Users/dougl/Desktop/TESTES_CAM_ZYBO/CAPTURE_FRAME/captura_frame/captura_frame.runs/captura_frame_proc_sys_reset_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log captura_frame_proc_sys_reset_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source captura_frame_proc_sys_reset_0_0.tcl
