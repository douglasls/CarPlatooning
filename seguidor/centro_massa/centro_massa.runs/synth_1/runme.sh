...
HD_PWD='C:/Users/DLustosa/Desktop/Teste_CAM_VGA/centro_massa/centro_massa.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log centroide.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source centroide.tcl
