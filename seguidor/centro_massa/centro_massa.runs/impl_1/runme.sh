...
HD_PWD='C:/Users/DLustosa/Desktop/Teste_CAM_VGA/centro_massa/centro_massa.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log centroide.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source centroide.tcl -notrace
